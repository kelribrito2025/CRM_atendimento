...
function lerConfig() {
  ...
  return {
    ...
    // Ambiente de teste: dados reais, mas nada sai para fora (ver src/sandbox.js).
    sandbox: lerFlag('MODO_SANDBOX', false),
    ...
    senhaPerfilAdmin: process.env.SENHA_PERFIL_ADMIN || '',
...
async function montarSistema(extras = {}) {
  ...
  const app = criarApp(db, {
    ...
    senhaPerfilAdmin: config.senhaPerfilAdmin,
